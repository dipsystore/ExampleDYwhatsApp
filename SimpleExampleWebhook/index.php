...
if ($message == 'template button') {
    $respon = $responFormatter->line('ini isi pesannya')->bold("tebal")
        ->addTemplateButton("Button pertama (kunjungi url ketika klik)", "https://wa.dipsy.id")
        ->addTemplateButton("Button kedua (panggilan telepon ketika klik)", "6285156448099", "call")
        ->footer('ini footer')
